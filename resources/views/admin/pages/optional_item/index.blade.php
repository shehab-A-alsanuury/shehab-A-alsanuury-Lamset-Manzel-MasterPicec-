								...
								<div class="sherah-dsinner">
									<div class="row mg-top-30">
                                        <div class="col-12 sherah-flex-between">
                                            ...
                                            <a href="{{route('admin.optional.item.create')}}" class="sherah-btn sherah-gbcolor">Create Optional Items</a>
                                        </div>
                                    </div>
												  ...
												  @endif
													<td class="sherah-table__column-8 sherah-table__data-8">
														<div class="sherah-table__status__group">
                                                            ...
                                                            <a href="{{route('admin.optional.item.destroy',$item->id)}}" onclick="confirmation(event)" class="sherah-table__action sherah-color2 sherah-color2__bg--offset blog_comment_delete">
...
<script>
    ...
    $.ajax({
        ...
        url: "{{ route('admin.optional.item.status.change', ':catId') }}".replace(':catId',Id),
        dataType: "json",
