                                        ...
                                        <div class="col-12 sherah-flex-between">
                                            <div class="sherah-breadcrumb">
                                                ...
                                                <ul class="sherah-breadcrumb__list">
                                                    ...
                                                    <li class="active"><a href="{{route('admin.categories')}}">Categories</a></li>
                                                </ul>
                                            </div>
                                            <!-- End Sherah Breadcrumb -->
                                            <a href="{{route('admin.category.create')}}" class="sherah-btn sherah-gbcolor">Create Category</a>
                                        </div>
                                    </div>
												  ...
												  @endif
													<td class="sherah-table__column-8 sherah-table__data-8">
														<div class="sherah-table__status__group">
                                                            ...
                                                            <a href="{{route('admin.category-destroy',$category->id)}}" onclick="confirmation(event)"  class="sherah-table__action sherah-color2 sherah-color2__bg--offset blog_comment_delete">
