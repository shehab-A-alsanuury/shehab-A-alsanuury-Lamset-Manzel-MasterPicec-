                                        ...
                                        <div class="col-12 sherah-flex-between">
                                            ...
                                            <div class="sherah-breadcrumb">
                                                ...
                                                <ul class="sherah-breadcrumb__list">
                                                    <li><a href="#">Home</a></li>
                                                    <li class="active"><a href="{{route('admin.faqs.index')}}">FAQs</a></li>
                                                </ul>
                                            </div>
                                            <!-- End Sherah Breadcrumb -->
                                            <a href="{{route('admin.faqs.create')}}" class="sherah-btn sherah-gbcolor">Create faqs</a>
                                        </div>
                                    </div>
												  ...
												  @endif
													<td class="sherah-table__column-8 sherah-table__data-8">
														<div class="sherah-table__status__group">
															...
															<a href="{{route('admin.faq.delete',$faq['id'])}}" onclick="confirmation(event)" class="sherah-table__action sherah-color2 sherah-color2__bg--offset">
...
<script>
    ...
    $.ajax({
        ...
        url: "{{ route('admin.faq.status.change', ':Id') }}".replace(':Id',Id),
        dataType: "json",
