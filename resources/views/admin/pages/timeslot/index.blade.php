								...
								<div class="sherah-dsinner">
									<div class="row mg-top-30">
                                        <div class="col-12 sherah-flex-between">
                                            ...
                                            <a href="{{route('admin.timeslot.create')}}" class="sherah-btn sherah-gbcolor">Create Time Slot</a>
                                        </div>
                                    </div>
												  ...
												  @endif
													<td class="sherah-table__column-8 sherah-table__data-8">
														<div class="sherah-table__status__group">
															<a href="{{route('admin.timeslot.edit',$slot->id)}}"  class="sherah-table__action sherah-color2 sherah-color3__bg--opactity">
                                                            ...
                                                            <a href="{{route('admin.timeslot.delete',$slot->id)}}" onclick="confirmation(event)" class="sherah-table__action sherah-color2 sherah-color2__bg--offset blog_comment_delete">
...
<script>
    ...
    $.ajax({
        ...
        url: "{{ route('admin.timeslot.change.status', ':Id') }}".replace(':Id',Id),
        dataType: "json",
