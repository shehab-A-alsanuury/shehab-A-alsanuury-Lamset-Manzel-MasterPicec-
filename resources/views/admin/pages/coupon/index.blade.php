                                        ...
                                        <div class="col-12 sherah-flex-between">
                                            <div class="sherah-breadcrumb">
                                                ...
                                                <ul class="sherah-breadcrumb__list">
                                                    ...
                                                    <li class="active"><a href="{{route('admin.coupon.index')}}">Coupon</a></li>
                                                </ul>
                                            </div>
                                            <!-- End Sherah Breadcrumb -->
                                            <a href="{{route('admin.coupon.create')}}" class="sherah-btn sherah-gbcolor">Create Coupon</a>
                                        </div>
                                    </div>
												  ...
												  @endif
													<td class="sherah-table__column-8 sherah-table__data-8">
														<div class="sherah-table__status__group">
															<a href="{{route('admin.coupon.edit',$coupon->id)}}"  class="sherah-table__action sherah-color2 sherah-color3__bg--opactity">
                                                            ...
                                                            <a href="{{route('admin.coupon.delete',$coupon->id)}}" onclick="confirmation(event)" class="sherah-table__action sherah-color2 sherah-color2__bg--offset blog_comment_delete">
...
<script>
    ...
    $.ajax({
        ...
        url: "{{ route('admin.coupon.change.status', ':Id') }}".replace(':Id',Id),
        dataType: "json",
