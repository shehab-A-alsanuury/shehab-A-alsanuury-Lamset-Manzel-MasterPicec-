							...
							<div class="sherah-body">
								...
								<div class="sherah-dsinner">
									...
									<div class="sherah-page-inner sherah-border sherah-basic-page sherah-default-bg mg-top-25 p-0">
                                        <form class="sherah-wc__form-main" action="{{route('admin.product.store')}}" method="POST" enctype= multipart/form-data >
                                        @csrf
                                            <div class="row">
                                                <div class="col-12">
                                                    <!-- Product Info -->
                                                                    ...
                                                                    <div class="checkbox-group">
                                                                        @foreach($items as $index => $item)
                                                                            <div class="checkbox-group__single">
                                                                                <input type="checkbox" value="{{$item->id}}" class="btn-check" name="items[]" id="option1{{ $index }}" >
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="image-upload-group">
                                                                            ...
                                                                            <div class="image-upload-group__single image-upload-group__single--upload">
                                                                                <input type="file" class="btn-check" name="tumb_image" id="input-img1" onchange="previewThumbnailImage('input-img1', 'preview-img')" autocomplete="off" required  />
                                                                ...
                                                                <div class="product-form-box sherah-border mg-top-30">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="image-upload-group">
                                                                            ...
                                                                            <div class="image-upload-group__single image-upload-group__single--upload">
                                                                                <input type="file" class="btn-check" name="vedio_tumb_image" id="input-img2" onchange="previewThumbnailImage('input-img2', 'preview-img1')" autocomplete="off" required />
...
<script>
 ...
 $(document).ready(function(){
   var i = 1;
   $("#add").click(function(){
       $('#dynamic_field').append('<tr id="row'+i+'"><td><input type="text" name="size[]" placeholder="Enter Size" class="form-control name_list"/></td><td><input type="number" name="price[]" placeholder="Enter Price" class="form-control name_email"/></td><td><button type="button" name="remove" id="'+i+'" class="btn btn-danger btn_remove">X</button></td></tr>');
     });
