								...
								<div class="sherah-dsinner">
									<div class="row mg-top-30">
                                        <div class="col-12 sherah-flex-between">
                                            ...
                                            <a href="{{route('admin.product.create')}}" class="sherah-btn sherah-gbcolor">Create Product</a>
                                        </div>
                                    </div>
												  ...
												  @endif
													<td class="sherah-table__column-8 sherah-table__data-8">
														<div class="sherah-table__status__group">
															<a href="{{route('admin.product.edit',$product->id)}}"  class="sherah-table__action sherah-color2 sherah-color3__bg--opactity">
                                                            ...
                                                            <a href="{{route('admin.product.destroy',$product->id)}}" onclick="confirmation(event)" class="sherah-table__action sherah-color2 sherah-color2__bg--offset blog_comment_delete">
                                                            ...
                                                            <a href="{{route('admin.product.gallery',$product->id)}}" class="sherah-table__action sherah-color2 sherah-color1__bg--offset blog_comment_delete">
...
<script>
    ...
    $.ajax({
        ...
        url: "{{ route('admin.product.item.status.change', ':catId') }}".replace(':catId',Id),
        dataType: "json",
