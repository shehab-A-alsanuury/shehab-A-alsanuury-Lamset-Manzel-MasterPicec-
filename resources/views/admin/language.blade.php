                                        ...
                                        <div class="col-12 sherah-flex-between">
                                            ...
                                            <div class="sherah-breadcrumb">
                                                ...
                                                <ul class="sherah-breadcrumb__list">
                                                    ...
                                                    <li class="active"><a href="{{route('admin.languages.index')}}">Language</a></li>
                                                </ul>
                                            </div>
                                            <!-- End Sherah Breadcrumb -->
                                            <a href="{{route('admin.languages.create')}}" class="sherah-btn sherah-gbcolor">Create Language</a>
                                        </div>
                                    </div>
												  ...
												  @endif
													<td class="sherah-table__column-8 sherah-table__data-8">
														<div class="sherah-table__status__group">
															<a href="{{route('admin.languages.edit',$language['id'])}}" class="sherah-table__action sherah-color2 sherah-color3__bg--opactity">
                                                            ...
                                                            <a href="{{route('admin.language.delete',$language['id'])}}" onclick="confirmation(event)" type="submit" class="sherah-table__action sherah-color2 sherah-color2__bg--offset">
...
<script>
    ...
    function changeStatus(Id)
    {
        $.ajax({
            ...
            url: "{{ route('admin.language-status', ':Id') }}".replace(':Id',Id),
            dataType: "json",
