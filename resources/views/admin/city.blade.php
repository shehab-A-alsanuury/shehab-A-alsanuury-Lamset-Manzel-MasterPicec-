								...
								<div class="sherah-dsinner">
									<div class="row mg-top-30">
                                        <div class="col-12 sherah-flex-between">
                                            ...
                                            <a href="{{route('admin.cities.create')}}" class="sherah-btn sherah-gbcolor">Create City</a>
                                        </div>
                                    </div>
                                                ...
                                                <tr>
													...
													<td class="sherah-table__column-8 sherah-table__data-8">
														<div class="sherah-table__status__group">
                                                            ...
                                                            <a href="{{route('admin.cities.delete',$city['id'])}}" onclick="confirmation(event)" type="submit" class="sherah-table__action sherah-color2 sherah-color2__bg--offset">
