								...
								<div class="sherah-dsinner">
									<div class="row mg-top-30">
                                        <div class="col-12 sherah-flex-between">
                                            ...
                                            <a href="{{route('admin.FooterSocialLink.create')}}" class="sherah-btn sherah-gbcolor">Add Link</a>
                                        </div>
                                    </div>
                                                ...
                                                <tr>
													...
													<td class="sherah-table__column-8 sherah-table__data-8">
														<div class="sherah-table__status__group">
															<a href="{{route('admin.FooterSocialLink.edit',$link['id'])}}" class="sherah-table__action sherah-color2 sherah-color3__bg--opactity">
															...
															<form action="{{route('admin.FooterSocialLink.destroy',$link->id)}}" method="POST">
																@csrf
																@method('DELETE')
