								...
								<div class="sherah-dsinner">
									<div class="row mg-top-30">
                                        <div class="col-12 sherah-flex-between">
                                            ...
                                            <a href="{{route('admin.testimonials.create')}}" class="sherah-btn sherah-gbcolor">Craete Testimonials</a>
                                        </div>
                                    </div>
                                                ...
                                                @endif
													<td class="sherah-table__column-8 sherah-table__data-8">
														<div class="sherah-table__status__group">
															<a href="{{route('admin.testimonials.edit',$testimonial['id'])}}" class="sherah-table__action sherah-color2 sherah-color3__bg--opactity">
																...
																<a href="{{route('admin.testimonials.delete',$testimonial['id'])}}" onclick="confirmation(event)" class="sherah-table__action sherah-color2 sherah-color2__bg--offset">
...
<script>
    ...
    function changeStatus(Id)
    {
        $.ajax({
            ...
            url: "{{ route('admin.testimonial.status.update', ':Id') }}".replace(':Id',Id),
            dataType: "json",
