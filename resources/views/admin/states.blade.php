								...
								<div class="sherah-dsinner">
									<div class="row mg-top-30">
                                        <div class="col-12 sherah-flex-between">
                                            ...
                                            <a href="{{route('admin.states.create')}}" class="sherah-btn sherah-gbcolor">Create State</a>
                                        </div>
                                    </div>
												  ...
												  @endif
													...
													<td class="sherah-table__column-8 sherah-table__data-8">
														...
														<a href="{{route('admin.states.edit',$state->id)}}" class="sherah-table__action sherah-color2 sherah-color3__bg--opactity">
															...
															<a href="{{route('admin.state.delete',$state->id)}}" onclick="confirmation(event)" class="sherah-table__action sherah-color2 sherah-color2__bg--offset">
...
function changeStatus(Id)
    ...
    $.ajax({
        ...
        url: "{{ route('admin.state-status', ':Id') }}".replace(':Id',Id),
        dataType: "json",
