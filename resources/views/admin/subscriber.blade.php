                                                ...
                                                <tr>
													...
													<td class="sherah-table__column-8 sherah-table__data-8">
														<div class="sherah-table__status__group">
                                                            <a href="{{route('admin.subscriber.delete',$subscriber['id'])}}" type="button" onclick="confirmation(event)" class="sherah-table__action sherah-color2 sherah-color2__bg--offset blog_comment_delete">
...
<script>
    ...
    function changeStatus(Id)
    {
        $.ajax({
            ...
            url: "{{ route('admin.subscriber.change.status', ':Id') }}".replace(':Id',Id),
            dataType: "json",
