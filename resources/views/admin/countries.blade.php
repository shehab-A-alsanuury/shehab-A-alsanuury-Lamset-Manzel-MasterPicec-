                                        ...
                                        <div class="col-12 sherah-flex-between">
                                            ...
                                            <div class="sherah-breadcrumb">
                                                ...
                                                <ul class="sherah-breadcrumb__list">
                                                    ...
                                                    <li class="active"><a href="{{route('admin.countries.index')}}">Countries</a></li>
                                                </ul>
                                            </div>
                                            <!-- End Sherah Breadcrumb -->
                                            <a href="{{route('admin.countries.create')}}" class="sherah-btn sherah-gbcolor">Create Countries</a>
                                        </div>
                                    </div>
                                                ...
                                                <tr>
												  ...
												  @endif
													<td class="sherah-table__column-8 sherah-table__data-8">
														...
														<a href="{{route('admin.countries.edit',$country->id)}}" class="sherah-table__action sherah-color2 sherah-color3__bg--opactity">
															...
															<a href="{{route('admin.country.delete',$country->id)}}" onclick="confirmation(event)" class="sherah-table__action sherah-color2 sherah-color2__bg--offset">
